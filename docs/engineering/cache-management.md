...
- `section.bin`: **per-flavor** — Latin builds **Version 56**, Chinese builds
  (`ENABLE_CHINESE_VERSION`) **Version 57**. Versions 56/57 invalidate cached
  pagination for focus-word break opportunities, image viewport clamping, and
  extra-wide line spacing. The same built-in font
