...
language selects Global. Changing the UI language updates the service host and
regional-app defaults. Existing mismatched settings are corrected and resaved
