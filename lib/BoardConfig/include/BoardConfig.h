...
// Any frontlight hardware (PWM GPIO or I2C LM3630A) exposes the brightness slider.
inline bool hasFrontlight() { return ACTIVE.frontlight.gpio != PIN_UNASSIGNED || hasI2cFrontlight(); }
// LM3630A drives two independent LED banks (Channel A warm / Channel B cool), so
// it exposes an adjustable warm/cool color temperature in addition to brightness.
inline bool hasColorTemperatureFrontlight() {
  return ACTIVE.i2cFrontlight.controller == I2cFrontlightController::Lm3630a;
}
